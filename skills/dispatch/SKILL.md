...
| Want worked examples of dispatch flows | `references/examples.md` | Normal flow, IPC question flow, first-run setup examples |
...
> **Need examples?** For worked examples of normal dispatch, IPC question flow, and first-run setup, read `references/examples.md`.
